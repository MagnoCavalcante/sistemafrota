...
# Configuração condicional para PostgreSQL (se DATABASE_URL estiver definido)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'magno.brt8@gmail.com'  # Seu email Gmail
EMAIL_HOST_PASSWORD = 'sua_senha_de_app'  # Senha de aplicativo do Gmail
DEFAULT_FROM_EMAIL = 'magno.brt8@gmail.com'
